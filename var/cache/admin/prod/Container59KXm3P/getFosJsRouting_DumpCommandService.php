 ...
 */
class getFosJsRouting_DumpCommandService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/friendsofsymfony/jsrouting-bundle/Command/DumpCommand.php';
