 ...
 */
class getFosHttpCache_Command_RefreshPathService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/friendsofsymfony/http-cache-bundle/src/Command/RefreshPathCommand.php';
