...
class getSuluPage_SmartContent_DataProviderPoolService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = ($container->privates['sulu.content.query_executor'] ?? $container->load('getSulu_Content_QueryExecutorService'));
        ...
        $instance->add('snippets', new \Sulu\Bundle\SnippetBundle\Content\SnippetDataProvider($c, new \Sulu\Bundle\SnippetBundle\Content\SnippetQueryBuilder(($container->services['sulu.content.structure_manager'] ?? $container->getSulu_Content_StructureManagerService()), ($container->services['sulu_page.extension.manager'] ?? $container->load('getSuluPage_Extension_ManagerService')), ($container->services['sulu.phpcr.session'] ?? $container->getSulu_Phpcr_SessionService()), 'i18n'), ($container->services['sulu.util.node_helper'] ?? $container->getSulu_Util_NodeHelperService()), $d, $e, ($container->services['sulu_snippet.reference_store.snippet'] ?? ($container->services['sulu_snippet.reference_store.snippet'] = new \Sulu\Bundle\WebsiteBundle\ReferenceStore\ReferenceStore())), $container->hasParameter("sulu_audience_targeting.enabled"), $f, $g));
