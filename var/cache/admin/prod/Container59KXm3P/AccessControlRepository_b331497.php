...
class AccessControlRepository_b331497 extends \Sulu\Bundle\SecurityBundle\Entity\AccessControlRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findByTypeAndIdAndRole', array('type' => $type, 'id' => $id, 'roleId' => $roleId), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findByTypeAndIdAndRole($type, $id, $roleId);
    }
    public function findByTypeAndId($type, $id, $system = null)
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findByTypeAndId', array('type' => $type, 'id' => $id, 'system' => $system), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findByTypeAndId($type, $id, $system);
    }
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findIdsWithGrantedPermissions', array('user' => $user, 'permission' => $permission, 'entityClass' => $entityClass, 'entityIds' => $entityIds, 'system' => $system, 'anonymousRoleId' => $anonymousRoleId), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findIdsWithGrantedPermissions($user, $permission, $entityClass, $entityIds, $system, $anonymousRoleId);
    }
