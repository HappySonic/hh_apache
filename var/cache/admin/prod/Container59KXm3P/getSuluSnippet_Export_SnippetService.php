...
class getSuluSnippet_Export_SnippetService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sulu_snippet.export.snippet'] = new \Sulu\Component\Snippet\Export\SnippetExport(($container->services['.container.private.twig'] ?? $container->load('get_Container_Private_TwigService')), ($container->services['sulu_snippet.repository'] ?? $container->load('getSuluSnippet_RepositoryService')), ($container->services['sulu_document_manager.document_manager'] ?? $container->getSuluDocumentManager_DocumentManagerService()), ($container->services['sulu_document_manager.document_inspector'] ?? $container->getSuluDocumentManager_DocumentInspectorService()), ($container->privates['sulu_page.export.manager'] ?? $container->load('getSuluPage_Export_ManagerService')), $container->parameters['sulu_snippet.export.snippet.formats']);
    }
}
