...
class App_KernelProdContainer extends Container
{
    ...
    {
        $a = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 4).'/log/admin/prod.log'), 100, true, NULL, false);
