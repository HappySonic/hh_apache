 ...
 */
class getFosJsRouting_ControllerService extends App_KernelProdContainer
{
    /*
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/friendsofsymfony/jsrouting-bundle/Controller/Controller.php';
