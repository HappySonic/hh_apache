...
class RoleSettingRepository_a294c9e extends \Sulu\Bundle\SecurityBundle\Entity\RoleSettingRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findSettingValue', array('roleId' => $roleId, 'key' => $key), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findSettingValue($roleId, $key);
    }
    public function findSetting($roleId, $key)
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findSetting', array('roleId' => $roleId, 'key' => $key), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findSetting($roleId, $key);
    }
