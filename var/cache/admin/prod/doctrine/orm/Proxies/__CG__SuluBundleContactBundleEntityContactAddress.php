 ...
 */
class ContactAddress extends \Sulu\Bundle\ContactBundle\Entity\ContactAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactAddress' . "\0" . 'main', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactAddress' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactAddress' . "\0" . 'address', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactAddress' . "\0" . 'contact'];
        }
