 ...
 */
class Permission extends \Sulu\Bundle\SecurityBundle\Entity\Permission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\Permission' . "\0" . 'context', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\Permission' . "\0" . 'permissions', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\Permission' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\Permission' . "\0" . 'role', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\Permission' . "\0" . 'module'];
        }
