 ...
 */
class SocialMediaProfileType extends \Sulu\Bundle\ContactBundle\Entity\SocialMediaProfileType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\SocialMediaProfileType' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\SocialMediaProfileType' . "\0" . 'name', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\SocialMediaProfileType' . "\0" . 'socialMediaProfiles'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SocialMediaProfileType $proxy) {
