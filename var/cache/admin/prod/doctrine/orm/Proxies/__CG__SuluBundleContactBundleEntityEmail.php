 ...
 */
class Email extends \Sulu\Bundle\ContactBundle\Entity\Email implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Email' . "\0" . 'email', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Email' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Email' . "\0" . 'emailType', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Email' . "\0" . 'contacts', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Email' . "\0" . 'accounts'];
        }
