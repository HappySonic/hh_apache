 ...
 */
class AddressType extends \Sulu\Bundle\ContactBundle\Entity\AddressType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AddressType' . "\0" . 'name', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AddressType' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AddressType' . "\0" . 'addresses'];
        }
    ...
    public function addAddresse(\Sulu\Bundle\ContactBundle\Entity\Address $addresses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAddresse', [$addresses]);

        return parent::addAddresse($addresses);
    }
    ...
    public function removeAddresse(\Sulu\Bundle\ContactBundle\Entity\Address $addresses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAddresse', [$addresses]);
