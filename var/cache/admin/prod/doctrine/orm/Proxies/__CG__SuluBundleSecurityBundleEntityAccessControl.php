 ...
 */
class AccessControl extends \Sulu\Bundle\SecurityBundle\Entity\AccessControl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\AccessControl' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\AccessControl' . "\0" . 'role', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\AccessControl' . "\0" . 'permissions', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\AccessControl' . "\0" . 'entityId', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\AccessControl' . "\0" . 'entityIdInteger', '' . "\0" . 'Sulu\\Bundle\\SecurityBundle\\Entity\\AccessControl' . "\0" . 'entityClass'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessControl $proxy) {
