...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'sulu_preview.preview.cache' => ($container->privates['sulu_preview.preview.cache'] ?? $container->getSuluPreview_Preview_CacheService());
            yield 'sulu_admin.collaboration_cache' => ($container->privates['sulu_admin.collaboration_cache'] ?? $container->getSuluAdmin_CollaborationCacheService());
