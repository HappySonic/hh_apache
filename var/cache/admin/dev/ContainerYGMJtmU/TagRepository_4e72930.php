...
class TagRepository_4e72930 extends \Sulu\Bundle\TagBundle\Entity\TagRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Sulu\Bundle\TagBundle\Entity\TagRepository|null wrapped object, if the proxy is initialized
     */
    ...
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findTagById', array('id' => $id), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findTagById($id);
    }

    public function findTagByName($name)
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findTagByName', array('name' => $name), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findTagByName($name);
    }

    public function findAllTags()
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findAllTags', array(), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findAllTags();
    }
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolderedeb5) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\TagBundle\\Entity\\TagRepository');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Sulu\\Bundle\\TagBundle\\Entity\\TagRepository');
...
if (!\class_exists('TagRepository_4e72930', false)) {
    \class_alias(__NAMESPACE__.'\\TagRepository_4e72930', 'TagRepository_4e72930', false);
}
