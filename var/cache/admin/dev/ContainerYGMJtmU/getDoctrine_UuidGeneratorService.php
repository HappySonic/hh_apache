...
class getDoctrine_UuidGeneratorService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/doctrine/orm/lib/Doctrine/ORM/Id/AbstractIdGenerator.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/doctrine-bridge/IdGenerator/UuidGenerator.php';
