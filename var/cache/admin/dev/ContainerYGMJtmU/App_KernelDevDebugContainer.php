...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Component/Webspace/Analyzer/Attributes/AdminRequestProcessor.php';
            ...
            include_once \dirname(__DIR__, 5).'/vendor/doctrine/dbal/src/Logging/SQLLogger.php';
            include_once \dirname(__DIR__, 5).'/vendor/doctrine/dbal/src/Logging/DebugStack.php';
            ...
            include_once \dirname(__DIR__, 5).'/vendor/doctrine/dbal/src/Logging/LoggerChain.php';
            ...
            include_once \dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/SecurityBundle/EventListener/UserLocaleListener.php';
            ...
            include_once \dirname(__DIR__, 5).'/vendor/doctrine/phpcr-bundle/src/DataCollector/AbstractPHPCRDataCollector.php';
            include_once \dirname(__DIR__, 5).'/vendor/doctrine/phpcr-bundle/src/DataCollector/PHPCRDataCollector.php';
    ...
    protected function get_Container_Private_ProfilerService()
    {
        ...
        $d->addInstance('sulu_preview.preview.cache', ($this->privates['sulu_preview.preview.cache'] ?? $this->getSuluPreview_Preview_CacheService()));
        $d->addInstance('sulu_admin.collaboration_cache', ($this->privates['sulu_admin.collaboration_cache'] ?? $this->getSuluAdmin_CollaborationCacheService()));
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 5).'/vendor/symfony/web-profiler-bundle/Resources/views'), '!WebProfiler');
        $a->addPath((\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/TestBundle/Resources/views'), 'SuluTest');
        $a->addPath((\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/TestBundle/Resources/views'), '!SuluTest');
        ...
        $f = ($this->services['sulu_core.array_serializer'] ?? $this->getSuluCore_ArraySerializerService());
        $g = ($this->privates['sulu_core.cache.memoize'] ?? $this->getSuluCore_Cache_MemoizeService());
        $h = ($this->services['sulu.content.mapper'] ?? $this->getSulu_Content_MapperService());
        $i = ($this->services['sulu_core.webspace.request_analyzer'] ?? $this->getSuluCore_Webspace_RequestAnalyzerService());
        $j = ($this->services['sulu_website.resolver.structure'] ?? $this->getSuluWebsite_Resolver_StructureService());
        $k = ($this->services['sulu_snippet.default_snippet.manager'] ?? $this->getSuluSnippet_DefaultSnippet_ManagerService());
        $l = ($this->services['sulu_snippet.resolver'] ?? $this->getSuluSnippet_ResolverService());
        $m = ($this->services['sulu_core.webspace.webspace_manager'] ?? $this->getSuluCore_Webspace_WebspaceManagerService());

        $n = new \Sulu\Bundle\WebsiteBundle\Twig\Content\ContentPathTwigExtension($m, 'dev', $i);
        $o = ($this->privates['sulu.content.query_executor'] ?? $this->getSulu_Content_QueryExecutorService());
        $p = ($this->services['sulu.content.structure_manager'] ?? $this->getSulu_Content_StructureManagerService());
        $q = ($this->services['sulu_page.extension.manager'] ?? $this->getSuluPage_Extension_ManagerService());
        $r = ($this->services['sulu.phpcr.session'] ?? $this->getSulu_Phpcr_SessionService());
        $s = new \Symfony\Component\VarDumper\Dumper\HtmlDumper(NULL, 'UTF-8', 1);
        $s->setDisplayOptions(['maxStringLength' => 4096, 'fileLinkFormat' => $c]);
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\ProfilerExtension(($this->privates['twig.profile'] ?? ($this->privates['twig.profile'] = new \Twig\Profiler\Profile())), NULL));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($c, \dirname(__DIR__, 5), 'UTF-8'));
        ...
        $instance->addExtension(new \Sulu\Bundle\CategoryBundle\Twig\CategoryTwigExtension(($this->services['sulu_category.category_manager'] ?? $this->getSuluCategory_CategoryManagerService()), ($this->privates['sulu_category.category_request_handler'] ?? $this->getSuluCategory_CategoryRequestHandlerService()), $f, $g));
        $instance->addExtension(new \Sulu\Bundle\SnippetBundle\Twig\MemoizedSnippetTwigExtension(new \Sulu\Bundle\SnippetBundle\Twig\SnippetTwigExtension($h, $i, $j), $g, 1));
        $instance->addExtension(new \Sulu\Bundle\SnippetBundle\Twig\DefaultSnippetTwigExtension($k, $i, $l));
        $instance->addExtension(new \Sulu\Bundle\SnippetBundle\Twig\SnippetAreaTwigExtension($k, $i, $l));
        ...
        $instance->addExtension(new \Sulu\Bundle\TagBundle\Twig\TagTwigExtension(($this->services['sulu_tag.tag_manager'] ?? $this->getSuluTag_TagManagerService()), ($this->privates['sulu_tag.tag_request_handler'] ?? $this->getSuluTag_TagRequestHandlerService()), $f, $g));
        $instance->addExtension($n);
        $instance->addExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Navigation\MemoizedNavigationTwigExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Navigation\NavigationTwigExtension($h, new \Sulu\Bundle\WebsiteBundle\Navigation\NavigationMapper($h, $o, new \Sulu\Bundle\WebsiteBundle\Navigation\NavigationQueryBuilder($p, $q, 'i18n'), $r, NULL, $this->parameters['sulu_security.permissions'], $this->parameters['sulu_website.enabled_twig_attributes']), $i), $g, 1));
        $instance->addExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Sitemap\MemoizedSitemapTwigExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Sitemap\SitemapTwigExtension(new \Sulu\Bundle\WebsiteBundle\Sitemap\SitemapGenerator($o, $m, new \Sulu\Bundle\WebsiteBundle\Sitemap\SitemapContentQueryBuilder($p, $q, 'i18n'), 'dev'), $m, 'dev', $i), $g, 1));
        $instance->addExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Content\MemoizedContentTwigExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Content\ContentTwigExtension($h, $j, $r, $i, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['sulu_security.security_checker'] ?? $this->getSuluSecurity_SecurityCheckerService()), $m, $d), $g, 1));
        $instance->addExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Meta\MetaTwigExtension($i, $n));
        $instance->addExtension(new \Sulu\Bundle\WebsiteBundle\Twig\Seo\SeoTwigExtension($i, $n, $d));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aHhnsSe7IQ', 0, (\dirname(__DIR__, 3).'/common/dev/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MLk4Hf1RrN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m1wn7ceUH6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->setSQLLogger(new \Doctrine\DBAL\Logging\LoggerChain([0 => new \Symfony\Bridge\Doctrine\Logger\DbalLogger(NULL, NULL), 1 => ($this->privates['doctrine.dbal.logger.profiling.default'] ?? ($this->privates['doctrine.dbal.logger.profiling.default'] = new \Doctrine\DBAL\Logging\DebugStack()))]));
        ...
        ]), [0 => 'sulu.persistence.event_subscriber.orm.metadata', 1 => 'sulu.persistence.event_subscriber.orm.user_blame', 2 => 'sulu_core.doctrine.references', 3 => 'doctrine.orm.listeners.resolve_target_entity', 4 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 5 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 6 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 7 => 'massive_search.search.event_subscriber.doctrine_orm', 8 => 'sulu.persistence.event_subscriber.orm.timestampable', 9 => 'sulu_security.permission_inheritance_subscriber', 10 => 'stof_doctrine_extensions.listener.tree', 11 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners'], 12 => [0 => [0 => 'postGenerateSchema'], 1 => 'doctrine_phpcr.jackalope_doctrine_dbal.schema_listener'], 13 => [0 => [0 => 'postPersist'], 1 => 'sulu_contact.account_listener'], 14 => [0 => [0 => 'postPersist'], 1 => 'sulu_contact.doctrine.invalidation_listener'], 15 => [0 => [0 => 'postUpdate'], 1 => 'sulu_contact.doctrine.invalidation_listener'], 16 => [0 => [0 => 'preRemove'], 1 => 'sulu_contact.doctrine.invalidation_listener'], 17 => [0 => [0 => 'postPersist'], 1 => 'sulu_media.doctrine.invalidation_listener'], 18 => [0 => [0 => 'postUpdate'], 1 => 'sulu_media.doctrine.invalidation_listener'], 19 => [0 => [0 => 'preRemove'], 1 => 'sulu_media.doctrine.invalidation_listener'], 20 => 'sulu_activity.domain_event_collector_subscriber']), []);
    }
    ...
    protected function get_Debug_HttpClientService()
    {
        ...
        return $this->privates['.debug.http_client'] = new \Symfony\Component\HttpClient\TraceableHttpClient($a, NULL);
    }

    /**
     * Gets the private '.service_locator.eLMgmZc' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_ELMgmZcService()
    {
        return $this->privates['.service_locator.eLMgmZc'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 5).'/public/build/website/manifest.json'), ($this->privates['.debug.http_client'] ?? $this->get_Debug_HttpClientService()), false), ($this->privates['assets.context'] ?? $this->getAssets_ContextService())), new RewindableGenerator(function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OM0yhClR3+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5NGECRQhoR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FaH8nibDGd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2dXes1ZIiq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LmuS2n1Nd0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nKLOy3p7r3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner($this->getEnv('APP_SECRET')))), '/admin/_fragments');
    }
    ...
    {
        return $this->privates['jms_serializer.metadata.traceable_file_locator'] = new \JMS\SerializerBundle\Debug\TraceableFileLocator(['Sulu\\Bundle\\AdminBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/AdminBundle/Resources/config/serializer'), 'Sulu\\Bundle\\SearchBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/SearchBundle/Resources/config/serializer'), 'Sulu\\Bundle\\CategoryBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/CategoryBundle/Resources/config/serializer'), 'Sulu\\Bundle\\SnippetBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/SnippetBundle/Resources/config/serializer'), 'Sulu\\Bundle\\PageBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/PageBundle/DependencyInjection/../Resources/config/serializer'), 'Sulu\\Bundle\\DocumentManagerBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/DocumentManagerBundle/Resources/config/serializer'), 'Sulu\\Bundle\\CustomUrlBundle' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/CustomUrlBundle/Resources/config/serializer'), 'Sulu\\Component\\CustomUrl' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/CustomUrlBundle/DependencyInjection/../Resources/config/serializer'), 'Sulu\\Component\\DocumentManager' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/DocumentManagerBundle/DependencyInjection/../Resources/config/serializer'), 'Sulu\\Component\\Content' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/PageBundle/DependencyInjection/../Resources/config/serializer'), 'Sulu\\Component\\Webspace' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/PageBundle/DependencyInjection/../Resources/config/serializer'), 'Sulu\\Bundle\\CategoryBundle\\Entity' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/CategoryBundle/DependencyInjection/../Resources/config/serializer'), 'Massive\\Bundle\\SearchBundle\\Search' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/SearchBundle/Resources/config/serializer/massive'), 'Sulu\\Bundle\\SearchBundle\\Search' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/SearchBundle/Resources/config/serializer/sulu'), 'Sulu\\Component\\SmartContent\\Configuration' => (\dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/AdminBundle/DependencyInjection/../Resources/config/serializer')]);
    }
    ...
    protected function getJmsSerializer_TraceableEventDispatcherService()
    {
        ...
        $instance->addListener('serializer.pre_serialize', [0 => 'sulu_page.document.serializer.subscriber.structure_behavior', 1 => 'onPreSerialize'], NULL, NULL, NULL);
        $instance->addListener('serializer.pre_serialize', [0 => 'sulu_page.document.serializer.subscriber.extension_container', 1 => 'onPreSerialize'], NULL, NULL, NULL);
        $instance->addListener('serializer.pre_serialize', [0 => 'sulu_document_manager.serializer.subscriber.proxy', 1 => 'onPreSerialize'], NULL, NULL, NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_core.representation_handler', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_admin.dropdown_toolbar_action_subscriber', 1 => 'onPostSerialize'], 'Sulu\\Bundle\\AdminBundle\\Admin\\View\\DropdownToolbarAction', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_admin.save_with_form_dialog_toolbar_action_subscriber', 1 => 'onPostSerialize'], 'Sulu\\Bundle\\AdminBundle\\Admin\\View\\SaveWithFormDialogToolbarAction', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_admin.toggler_toolbar_action_subscriber', 1 => 'onPostSerialize'], 'Sulu\\Bundle\\AdminBundle\\Admin\\View\\TogglerToolbarAction', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_security.serializer.media_permissions', 1 => 'onPostSerialize'], NULL, NULL, NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_security.serializer.handler.secured_entity', 1 => 'onPostSerialize'], NULL, NULL, NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_security.document.serializer.subscriber.security', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.webspace.serializer.event_subscriber', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.content_repository.event_subscriber', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.teaser.serializer.event_subscriber', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.structure_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.path_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.parent_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.locale', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.shadow_locale_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.redirect_type_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.document.serializer.subscriber.workflow_stage_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_page.compat.serializer.subscriber.page_bridge', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_website.analytics.event_subscriber', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_document_manager.serializer.subscriber.children_behavior', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_hash.event_subscriber.serializer', 1 => 'onPostSerialize'], NULL, NULL, NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'sulu_custom_urls.serializer.event_subscriber', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_deserialize', [0 => 'sulu_document_manager.serializer.subscriber.document', 1 => 'onPostDeserialize'], NULL, NULL, NULL);
    ...
    protected function getJmsSerializer_TraceableHandlerRegistryService()
    {
        ...
        $instance->registerHandler(2, 'DateTime', 'array', [0 => 'sulu_core.rest.datetime_handler', 1 => 'deserialize']);
        ...
        $instance->registerHandler(2, 'DateTimeImmutable', 'array', [0 => 'sulu_core.rest.datetime_handler', 1 => 'deserialize']);
        ...
        $instance->registerHandler(2, 'Sulu\\Component\\Content\\Document\\Structure\\Structure', 'json', [0 => 'sulu_page.document.serializer.handler.structure', 1 => 'doDeserialize']);
        $instance->registerHandler(2, 'Sulu\\Component\\Content\\Document\\Extension\\ExtensionContainer', 'json', [0 => 'sulu_page.document.serializer.handler.extension_container', 1 => 'doDeserialize']);
        $instance->registerHandler(2, 'Sulu\\Component\\Content\\Compat\\Structure\\PageBridge', 'json', [0 => 'sulu_page.compat.serializer.handler.page_bridge', 1 => 'doDeserialize']);
        $instance->registerHandler(1, 'DateTime', 'array', [0 => 'sulu_core.rest.datetime_handler', 1 => 'serialize']);
        ...
        $instance->registerHandler(1, 'DateTimeImmutable', 'array', [0 => 'sulu_core.rest.datetime_handler', 1 => 'serialize']);
        ...
        $instance->registerHandler(1, 'Sulu\\Bundle\\AdminBundle\\Metadata\\SchemaMetadata\\SchemaMetadata', 'json', [0 => 'sulu_admin.schema_handler', 1 => 'serializeToJsonSchema']);
        $instance->registerHandler(1, 'Sulu\\Component\\Content\\Document\\Structure\\Structure', 'json', [0 => 'sulu_page.document.serializer.handler.structure', 1 => 'doSerialize']);
        $instance->registerHandler(1, 'Sulu\\Component\\Content\\Document\\Extension\\ExtensionContainer', 'json', [0 => 'sulu_page.document.serializer.handler.extension_container', 1 => 'doSerialize']);
        $instance->registerHandler(1, 'Sulu\\Component\\DocumentManager\\Collection\\ChildrenCollection', 'json', [0 => 'sulu_document_manager.serializer.handler.children_collection', 1 => 'doSerialize']);
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 4).'/log/admin/dev.log'), 100, true, NULL, false);
     ...
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getSuluAdmin_CollaborationCacheService()
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0ruz048EjZ', 0, (\dirname(__DIR__, 3).'/common/dev/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));

        return $this->privates['sulu_admin.collaboration_cache'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
     ...
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getSuluPreview_Preview_CacheService()
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VcR6EYWzdZ', 0, (\dirname(__DIR__, 3).'/common/dev/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));

        return $this->privates['sulu_preview.preview.cache'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    {
        return $this->privates['sulu_security.user_locale_listener'] = new \Sulu\Bundle\SecurityBundle\EventListener\UserLocaleListener(($this->services['.container.private.security.token_storage'] ?? $this->get_Container_Private_Security_TokenStorageService()), ($this->services['translator'] ?? $this->getTranslatorService()));
    }
    ...
    {
        $a = ($this->privates['.service_locator.eLMgmZc'] ?? $this->get_ServiceLocator_ELMgmZcService());
