...
class getJmsSerializer_Cache_CacheClearerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/jms/serializer-bundle/Cache/CacheClearer.php';

        return $container->privates['jms_serializer.cache.cache_clearer'] = new \JMS\SerializerBundle\Cache\CacheClearer(($container->privates['jms_serializer.metadata.traceable_cache'] ?? $container->getJmsSerializer_Metadata_TraceableCacheService()));
    }
}
