...
class getSwiftmailer_Command_SendEmailService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/swiftmailer-bundle/Command/AbstractSwiftMailerCommand.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/swiftmailer-bundle/Command/SendEmailCommand.php';
