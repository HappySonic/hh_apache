...
class AnalyticsRepository_b1da81f extends \Sulu\Bundle\WebsiteBundle\Entity\AnalyticsRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findByWebspaceKey', array('webspaceKey' => $webspaceKey, 'environment' => $environment), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findByWebspaceKey($webspaceKey, $environment);
    }
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findByUrl', array('url' => $url, 'webspaceKey' => $webspaceKey, 'environment' => $environment), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findByUrl($url, $webspaceKey, $environment);
    }
