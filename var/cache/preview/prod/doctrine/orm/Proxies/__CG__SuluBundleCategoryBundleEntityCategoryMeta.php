 ...
 */
class CategoryMeta extends \Sulu\Bundle\CategoryBundle\Entity\CategoryMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'key', 'value', 'locale', 'id', 'category'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryMeta $proxy) {
