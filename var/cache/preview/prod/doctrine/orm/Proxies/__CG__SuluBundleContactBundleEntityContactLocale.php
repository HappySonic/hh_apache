 ...
 */
class ContactLocale extends \Sulu\Bundle\ContactBundle\Entity\ContactLocale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactLocale' . "\0" . 'locale', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactLocale' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\ContactLocale' . "\0" . 'contact'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactLocale $proxy) {
