 ...
 */
class Phone extends \Sulu\Bundle\ContactBundle\Entity\Phone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Phone' . "\0" . 'phone', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Phone' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Phone' . "\0" . 'phoneType', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Phone' . "\0" . 'contacts', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Phone' . "\0" . 'accounts'];
        }
    ...
    public function setPhoneType(\Sulu\Bundle\ContactBundle\Entity\PhoneType $phoneType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPhoneType', [$phoneType]);

        return parent::setPhoneType($phoneType);
    }
