 ...
 */
class AccountContact extends \Sulu\Bundle\ContactBundle\Entity\AccountContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AccountContact' . "\0" . 'main', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AccountContact' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AccountContact' . "\0" . 'contact', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AccountContact' . "\0" . 'account', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\AccountContact' . "\0" . 'position'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccountContact $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setAccount(\Sulu\Bundle\ContactBundle\Entity\AccountInterface $account)
    {
     ...
     * {@inheritDoc}
     */
    public function setPosition(\Sulu\Bundle\ContactBundle\Entity\Position $position = NULL)
    {
