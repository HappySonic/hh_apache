...
class AnalyticsRepository_b1da81f extends \Sulu\Bundle\WebsiteBundle\Entity\AnalyticsRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Sulu\Bundle\WebsiteBundle\Entity\AnalyticsRepository|null wrapped object, if the proxy is initialized
     */
    ...
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findByWebspaceKey', array('webspaceKey' => $webspaceKey, 'environment' => $environment), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findByWebspaceKey($webspaceKey, $environment);
    }

    public function findById(int $id) : \Sulu\Bundle\WebsiteBundle\Entity\AnalyticsInterface
    {
    ...
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findByUrl', array('url' => $url, 'webspaceKey' => $webspaceKey, 'environment' => $environment), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findByUrl($url, $webspaceKey, $environment);
    }
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolderedeb5) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\WebsiteBundle\\Entity\\AnalyticsRepository');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Sulu\\Bundle\\WebsiteBundle\\Entity\\AnalyticsRepository');
...
if (!\class_exists('AnalyticsRepository_b1da81f', false)) {
    \class_alias(__NAMESPACE__.'\\AnalyticsRepository_b1da81f', 'AnalyticsRepository_b1da81f', false);
}
