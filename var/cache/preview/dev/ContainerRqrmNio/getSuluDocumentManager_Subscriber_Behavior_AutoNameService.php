 ...
 */
class getSuluDocumentManager_Subscriber_Behavior_AutoNameService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sulu_document_manager.subscriber.behavior.auto_name'] = new \Sulu\Component\DocumentManager\Subscriber\Behavior\Path\AutoNameSubscriber(($container->privates['sulu_document_manager.document_registry'] ?? ($container->privates['sulu_document_manager.document_registry'] = new \Sulu\Component\DocumentManager\DocumentRegistry('en'))), new \Sulu\Component\DocumentManager\Slugifier\NodeNameSlugifier(new \Sulu\Component\DocumentManager\Slugifier\PathCleanupSlugifier(($container->services['sulu.content.path_cleaner'] ?? $container->getSulu_Content_PathCleanerService()))), new \Sulu\Component\DocumentManager\NameResolver(), ($container->privates['sulu_document_manager.node_manager'] ?? $container->getSuluDocumentManager_NodeManagerService()), ($container->services['sulu_document_manager.live_session'] ?? $container->getSuluDocumentManager_LiveSessionService()), ($container->services['doctrine_phpcr.session'] ?? $container->getDoctrinePhpcr_SessionService()));
    }
}
