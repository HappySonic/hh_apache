 ...
 */
class getSulu_Core_LocalizationManagerService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addLocalizationProvider(new \Sulu\Component\Webspace\Manager\WebspaceManager(($container->privates['sulu_core.webspace.loader.delegator'] ?? $container->getSuluCore_Webspace_Loader_DelegatorService()), ($container->privates['sulu_core.webspace.webspace_manager.url_replacer'] ?? ($container->privates['sulu_core.webspace.webspace_manager.url_replacer'] = new \Sulu\Component\Webspace\Url\Replacer())), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ['config_dir' => (\dirname(__DIR__, 5).'/config/webspaces'), 'cache_dir' => ($container->targetDir.''.'/sulu'), 'debug' => true, 'cache_class' => 'websiteWebspaceCollectionCache', 'base_class' => 'WebspaceCollection'], 'dev', 'localhost', 'http', ($container->services['sulu_page.structure.factory'] ?? $container->getSuluPage_Structure_FactoryService())));
