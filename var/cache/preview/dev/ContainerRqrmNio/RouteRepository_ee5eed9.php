...
class RouteRepository_ee5eed9 extends \Sulu\Bundle\RouteBundle\Entity\RouteRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findByPath', array('path' => $path, 'locale' => $locale), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findByPath($path, $locale);
    }

    public function findByEntity($entityClass, $entityId, $locale)
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findByEntity($entityClass, $entityId, $locale);
    }

    public function findHistoryByEntity($entityClass, $entityId, $locale)
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findHistoryByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findHistoryByEntity($entityClass, $entityId, $locale);
    }

    public function findAllByEntity($entityClass, $entityId, $locale = null)
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findAllByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findAllByEntity($entityClass, $entityId, $locale);
    }

    public function persist(\Sulu\Bundle\RouteBundle\Model\RouteInterface $route)
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'persist', array('route' => $route), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->persist($route);
    }

    public function remove(\Sulu\Bundle\RouteBundle\Model\RouteInterface $route)
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'remove', array('route' => $route), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->remove($route);
    }
