 ...
 */
class getSulu_Repository_ActivityService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        if ($lazyLoad) {
            return $container->services['sulu.repository.activity'] = $container->createProxy('EntityRepository_9af69de', function () use ($container) {
        ...
        return new \Sulu\Component\Persistence\Repository\ORM\EntityRepository($a, $a->getClassMetadata('Sulu\\Bundle\\ActivityBundle\\Domain\\Model\\Activity'));
    }
}
