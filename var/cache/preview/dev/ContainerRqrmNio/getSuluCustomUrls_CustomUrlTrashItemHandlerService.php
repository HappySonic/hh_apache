 ...
 */
class getSuluCustomUrls_CustomUrlTrashItemHandlerService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/CustomUrlBundle/Trash/CustomUrlTrashItemHandler.php';

        return $container->privates['sulu_custom_urls.custom_url_trash_item_handler'] = new \Sulu\Bundle\CustomUrlBundle\Trash\CustomUrlTrashItemHandler(($container->privates['sulu_trash.trash_item_repository'] ?? $container->getSuluTrash_TrashItemRepositoryService()), ($container->services['sulu_document_manager.document_manager'] ?? $container->getSuluDocumentManager_DocumentManagerService()), ($container->services['sulu_document_manager.document_inspector'] ?? $container->getSuluDocumentManager_DocumentInspectorService()), ($container->privates['sulu_document_manager.document_domain_event_collector'] ?? $container->getSuluDocumentManager_DocumentDomainEventCollectorService()));
    }
}
