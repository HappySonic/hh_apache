...
class CategoryTranslationRepository_5ea8703 extends \Sulu\Bundle\CategoryBundle\Entity\CategoryTranslationRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Sulu\Bundle\CategoryBundle\Entity\CategoryTranslationRepository|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolderedeb5) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\CategoryBundle\\Entity\\CategoryTranslationRepository');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Sulu\\Bundle\\CategoryBundle\\Entity\\CategoryTranslationRepository');
...
if (!\class_exists('CategoryTranslationRepository_5ea8703', false)) {
    \class_alias(__NAMESPACE__.'\\CategoryTranslationRepository_5ea8703', 'CategoryTranslationRepository_5ea8703', false);
}
