 ...
 */
class getSecurity_EventDispatcher_AdminService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
            return ($container->privates['security.logout.listener.legacy_success_listener.admin'] ?? $container->load('getSecurity_Logout_Listener_LegacySuccessListener_AdminService'));
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
        ...
        $instance->addListener('security.interactive_login', [0 => function () use ($container) {
            return ($container->privates['sulu_security.last_login_listener'] ?? $container->load('getSuluSecurity_LastLoginListenerService'));
