...
class CategoryMetaRepository_d16c689 extends \Sulu\Bundle\CategoryBundle\Entity\CategoryMetaRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    /**
     * @var \Sulu\Bundle\CategoryBundle\Entity\CategoryMetaRepository|null wrapped object, if the proxy is initialized
     */
    ...
    public function __construct(\Doctrine\ORM\EntityManagerInterface $em, \Doctrine\ORM\Mapping\ClassMetadata $class)
    {
        ...
        if (! $this->valueHolderedeb5) {
            $reflection = $reflection ?? new \ReflectionClass('Sulu\\Bundle\\CategoryBundle\\Entity\\CategoryMetaRepository');
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Sulu\\Bundle\\CategoryBundle\\Entity\\CategoryMetaRepository');
...
if (!\class_exists('CategoryMetaRepository_d16c689', false)) {
    \class_alias(__NAMESPACE__.'\\CategoryMetaRepository_d16c689', 'CategoryMetaRepository_d16c689', false);
}
