 ...
 */
class getSuluLocation_Content_Type_LocationService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Bundle/LocationBundle/Content/Types/LocationContentType.php';
