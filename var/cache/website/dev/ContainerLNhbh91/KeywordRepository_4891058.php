...
class KeywordRepository_4891058 extends \Sulu\Bundle\CategoryBundle\Entity\KeywordRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerb5509 && ($this->initializerb5509->__invoke($valueHolderedeb5, $this, 'findByKeyword', array('keyword' => $keyword, 'locale' => $locale), $this->initializerb5509) || 1) && $this->valueHolderedeb5 = $valueHolderedeb5;

        return $this->valueHolderedeb5->findByKeyword($keyword, $locale);
    }
