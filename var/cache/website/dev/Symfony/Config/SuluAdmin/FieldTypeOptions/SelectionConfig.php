...
require_once __DIR__.\DIRECTORY_SEPARATOR.'SelectionConfig'.\DIRECTORY_SEPARATOR.'ViewConfig.php';
require_once __DIR__.\DIRECTORY_SEPARATOR.'SelectionConfig'.\DIRECTORY_SEPARATOR.'TypesConfig.php';
...
class SelectionConfig 
{
     ...
     * @return $this
     */
    public function defaultType($value): self
    {
     ...
     * @return $this
     */
    public function resourceKey($value): self
    {
    ...
    public function view(array $value = []): \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\ViewConfig
    {
        if (null === $this->view) {
            $this->_usedProperties['view'] = true;
            $this->view = new \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\ViewConfig($value);
        } elseif ([] !== $value) {
    ...
    public function types(array $value = []): \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\TypesConfig
    {
        if (null === $this->types) {
            $this->_usedProperties['types'] = true;
            $this->types = new \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\TypesConfig($value);
        } elseif ([] !== $value) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('view', $value)) {
            $this->_usedProperties['view'] = true;
            $this->view = new \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\ViewConfig($value['view']);
            unset($value['view']);
        }
    
        if (array_key_exists('types', $value)) {
            $this->_usedProperties['types'] = true;
            $this->types = new \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\TypesConfig($value['types']);
            unset($value['types']);
        }
