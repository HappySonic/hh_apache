...
class StructureConfig 
{
     ...
     * @return $this
     */
    public function defaultType(string $name, $value): self
    {
     ...
     * @return $this
     */
    public function requiredProperties(string $type, $value): self
    {
     ...
     * @return $this
     */
    public function requiredTags(string $type, $value): self
    {
     ...
     * @return $this
     */
    public function typeMap(string $name, $value): self
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('paths', $value)) {
            $this->_usedProperties['paths'] = true;
            $this->paths = array_map(function ($v) { return new \Symfony\Config\SuluCore\Content\Structure\PathsConfig($v); }, $value['paths']);
            unset($value['paths']);
        }
