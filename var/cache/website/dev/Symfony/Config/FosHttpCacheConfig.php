...
class FosHttpCacheConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    public function userContext(array $value = []): \Symfony\Config\FosHttpCache\UserContextConfig
    {
    ...
    public function flashMessage(array $value = []): \Symfony\Config\FosHttpCache\FlashMessageConfig
    {
    ...
    public function debug(array $value = []): \Symfony\Config\FosHttpCache\DebugConfig
    {
        if (null === $this->debug) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('cache_manager', $value)) {
            $this->_usedProperties['cacheManager'] = true;
            $this->cacheManager = new \Symfony\Config\FosHttpCache\CacheManagerConfig($value['cache_manager']);
        ...
        if (array_key_exists('user_context', $value)) {
            $this->_usedProperties['userContext'] = true;
            $this->userContext = new \Symfony\Config\FosHttpCache\UserContextConfig($value['user_context']);
            unset($value['user_context']);
        }
    
        if (array_key_exists('flash_message', $value)) {
            $this->_usedProperties['flashMessage'] = true;
            $this->flashMessage = new \Symfony\Config\FosHttpCache\FlashMessageConfig($value['flash_message']);
        ...
        if (array_key_exists('debug', $value)) {
            $this->_usedProperties['debug'] = true;
            $this->debug = new \Symfony\Config\FosHttpCache\DebugConfig($value['debug']);
            unset($value['debug']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['userContext'])) {
            $output['user_context'] = $this->userContext->toArray();
        }
        if (isset($this->_usedProperties['flashMessage'])) {
            $output['flash_message'] = $this->flashMessage->toArray();
        }
