...
class OdmConfig 
{
     ...
     * @return $this
     */
    public function localeChooser($value): self
    {
    ...
    public function documentManager(string $name, array $value = []): \Symfony\Config\DoctrinePhpcr\Odm\DocumentManagerConfig
    {
        if (!isset($this->documentManagers[$name])) {
            ...
            return $this->documentManagers[$name] = new \Symfony\Config\DoctrinePhpcr\Odm\DocumentManagerConfig($value);
        }
        if ([] === $value) {
     ...
     * @return $this
     */
    public function locale(string $name, $value): self
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('document_managers', $value)) {
            $this->_usedProperties['documentManagers'] = true;
            $this->documentManagers = array_map(function ($v) { return new \Symfony\Config\DoctrinePhpcr\Odm\DocumentManagerConfig($v); }, $value['document_managers']);
