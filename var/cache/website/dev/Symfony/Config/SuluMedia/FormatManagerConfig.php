...
class FormatManagerConfig 
{
     ...
     * @return $this
     */
    public function responseHeaders($value): self
    {
     ...
     * @return $this
     */
    public function defaultImagineOptions($value): self
    {
     ...
     * @return $this
     */
    public function blockedFileTypes($value): self
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('types', $value)) {
            $this->_usedProperties['types'] = true;
            $this->types = array_map(function ($v) { return new \Symfony\Config\SuluMedia\FormatManager\TypesConfig($v); }, $value['types']);
            unset($value['types']);
        }
