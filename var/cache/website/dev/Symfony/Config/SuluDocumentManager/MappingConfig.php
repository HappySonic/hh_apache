...
class MappingConfig 
{
     ...
     * @return $this
     */
    public function phpcrType($value): self
    {
     ...
     * @return $this
     */
    public function syncRemoveLive($value): self
    {
     ...
     * @return $this
     */
    public function setDefaultAuthor($value): self
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('mapping', $value)) {
            $this->_usedProperties['mapping'] = true;
            $this->mapping = array_map(function ($v) { return new \Symfony\Config\SuluDocumentManager\MappingConfig\MappingConfig($v); }, $value['mapping']);
            unset($value['mapping']);
        }
