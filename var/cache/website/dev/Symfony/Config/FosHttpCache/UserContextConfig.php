...
class UserContextConfig 
{
     ...
     * @return $this
     */
    public function hashCacheTtl($value): self
    {
     ...
     * @return $this
     */
    public function alwaysVaryOnContextHash($value): self
    {
     ...
     * @return $this
     */
    public function userIdentifierHeaders($value): self
    {
     ...
     * @return $this
     */
    public function sessionNamePrefix($value): self
    {
     ...
     * @return $this
     */
    public function userHashHeader($value): self
    {
     ...
     * @return $this
     */
    public function roleProvider($value): self
    {
    ...
    public function logoutHandler(array $value = []): \Symfony\Config\FosHttpCache\UserContext\LogoutHandlerConfig
    {
        if (null === $this->logoutHandler) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('logout_handler', $value)) {
            $this->_usedProperties['logoutHandler'] = true;
            $this->logoutHandler = new \Symfony\Config\FosHttpCache\UserContext\LogoutHandlerConfig($value['logout_handler']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['logoutHandler'])) {
            $output['logout_handler'] = $this->logoutHandler->toArray();
        }
