...
class MatchConfig 
{
     ...
     * @return $this
     */
    public function method(string $name, $value): self
    {
     ...
     * @return $this
     */
    public function ip(string $name, $value): self
    {
     ...
     * @return $this
     */
    public function additionalResponseStatus($value): self
    {
     ...
     * @return $this
     */
    public function matchResponse($value): self
    {
