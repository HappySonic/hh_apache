...
class AnalyticsRepository_b1da81f extends \Sulu\Bundle\WebsiteBundle\Entity\AnalyticsRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findByWebspaceKey', array('webspaceKey' => $webspaceKey, 'environment' => $environment), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findByWebspaceKey($webspaceKey, $environment);
    }
    ...
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findByUrl', array('url' => $url, 'webspaceKey' => $webspaceKey, 'environment' => $environment), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findByUrl($url, $webspaceKey, $environment);
    }
