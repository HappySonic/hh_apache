...
class RoleSettingRepository_a294c9e extends \Sulu\Bundle\SecurityBundle\Entity\RoleSettingRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findSettingValue', array('roleId' => $roleId, 'key' => $key), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findSettingValue($roleId, $key);
    }

    public function findSetting($roleId, $key)
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findSetting', array('roleId' => $roleId, 'key' => $key), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findSetting($roleId, $key);
    }
