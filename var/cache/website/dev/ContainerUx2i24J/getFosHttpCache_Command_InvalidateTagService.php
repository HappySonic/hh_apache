 ...
 */
class getFosHttpCache_Command_InvalidateTagService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/friendsofsymfony/http-cache-bundle/src/Command/InvalidateTagCommand.php';
