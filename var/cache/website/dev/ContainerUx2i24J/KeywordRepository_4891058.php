...
class KeywordRepository_4891058 extends \Sulu\Bundle\CategoryBundle\Entity\KeywordRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findByKeyword', array('keyword' => $keyword, 'locale' => $locale), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findByKeyword($keyword, $locale);
    }
