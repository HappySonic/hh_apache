...
class RouteRepository_ee5eed9 extends \Sulu\Bundle\RouteBundle\Entity\RouteRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findByPath', array('path' => $path, 'locale' => $locale), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findByPath($path, $locale);
    }

    public function findByEntity($entityClass, $entityId, $locale)
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findByEntity($entityClass, $entityId, $locale);
    }

    public function findHistoryByEntity($entityClass, $entityId, $locale)
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findHistoryByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findHistoryByEntity($entityClass, $entityId, $locale);
    }

    public function findAllByEntity($entityClass, $entityId, $locale = null)
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'findAllByEntity', array('entityClass' => $entityClass, 'entityId' => $entityId, 'locale' => $locale), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->findAllByEntity($entityClass, $entityId, $locale);
    }

    public function persist(\Sulu\Bundle\RouteBundle\Model\RouteInterface $route)
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'persist', array('route' => $route), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->persist($route);
    }

    public function remove(\Sulu\Bundle\RouteBundle\Model\RouteInterface $route)
    {
        $this->initializer853e4 && ($this->initializer853e4->__invoke($valueHolder4a50a, $this, 'remove', array('route' => $route), $this->initializer853e4) || 1) && $this->valueHolder4a50a = $valueHolder4a50a;

        return $this->valueHolder4a50a->remove($route);
    }
