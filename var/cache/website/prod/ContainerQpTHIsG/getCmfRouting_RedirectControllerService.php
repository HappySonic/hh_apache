 ...
 */
class getCmfRouting_RedirectControllerService extends App_KernelProdContainer
{
    /*
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony-cmf/routing-bundle/src/Controller/RedirectController.php';
