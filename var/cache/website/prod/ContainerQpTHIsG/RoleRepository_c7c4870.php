...
class RoleRepository_c7c4870 extends \Sulu\Bundle\SecurityBundle\Entity\RoleRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findRoleById', array('id' => $id), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findRoleById($id);
    }
    public function findRoleByNameAndSystem($name, $system)
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findRoleByNameAndSystem', array('name' => $name, 'system' => $system), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findRoleByNameAndSystem($name, $system);
    }
    public function findAllRoles(array $filters = [])
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findAllRoles', array('filters' => $filters), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findAllRoles($filters);
    }
    public function getRoleNames()
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'getRoleNames', array(), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->getRoleNames();
    }
    public function findRoleIdsBySystem($system)
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findRoleIdsBySystem', array('system' => $system), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findRoleIdsBySystem($system);
    }
