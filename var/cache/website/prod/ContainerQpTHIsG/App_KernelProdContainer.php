...
class App_KernelProdContainer extends Container
{
    ...
    {
        $a = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 4).'/log/website/prod.log'), 100, true, NULL, false);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['sulu_security.security_context_voter'] ?? $this->load('getSuluSecurity_SecurityContextVoterService'));
        }, 4), new \Symfony\Component\Security\Core\Authorization\Strategy\UnanimousStrategy(true));
    }
