 ...
 */
class getCmfRouting_RouteTypeFormTypeService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony-cmf/routing-bundle/src/Form/Type/RouteTypeType.php';
