...
class get_Container_Private_SerializerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/sulu/sulu/src/Sulu/Component/Rest/FlattenExceptionNormalizer.php';
        include_once \dirname(__DIR__, 5).'/vendor/friendsofsymfony/rest-bundle/Serializer/Normalizer/FlattenExceptionNormalizer.php';
        ...
        return $container->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 2 => new \Sulu\Component\Rest\FlattenExceptionNormalizer(new \FOS\RestBundle\Serializer\Normalizer\FlattenExceptionNormalizer(($container->privates['fos_rest.exception.codes_map'] ?? $container->getFosRest_Exception_CodesMapService()), ($container->privates['fos_rest.exception.messages_map'] ?? ($container->privates['fos_rest.exception.messages_map'] = new \FOS\RestBundle\Util\ExceptionValueMap([]))), false, false), ($container->services['translator'] ?? $container->getTranslatorService())), 3 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false), 4 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 6 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 7 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $c), 8 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($b, $c, $d, $e, NULL, [])), 9 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 10 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 11 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 13 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? $container->load('getMimeTypesService'))), 14 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($b, $c, $a, $d, $e, NULL, [])], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder()]);
    }
}
