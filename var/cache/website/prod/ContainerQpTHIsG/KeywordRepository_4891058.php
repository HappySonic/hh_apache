...
class KeywordRepository_4891058 extends \Sulu\Bundle\CategoryBundle\Entity\KeywordRepository implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializera2e88 && ($this->initializera2e88->__invoke($valueHolder8c057, $this, 'findByKeyword', array('keyword' => $keyword, 'locale' => $locale), $this->initializera2e88) || 1) && $this->valueHolder8c057 = $valueHolder8c057;
        return $this->valueHolder8c057->findByKeyword($keyword, $locale);
    }
