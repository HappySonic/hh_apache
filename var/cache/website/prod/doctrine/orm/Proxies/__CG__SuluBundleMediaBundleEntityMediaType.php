 ...
 */
class MediaType extends \Sulu\Bundle\MediaBundle\Entity\MediaType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\MediaType' . "\0" . 'name', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\MediaType' . "\0" . 'description', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\MediaType' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\MediaType' . "\0" . 'media'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MediaType $proxy) {
