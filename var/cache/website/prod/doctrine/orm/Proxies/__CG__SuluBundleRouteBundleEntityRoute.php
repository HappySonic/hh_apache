...
class Route extends \Sulu\Bundle\RouteBundle\Entity\Route implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'path', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'locale', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'entityClass', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'entityId', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'history', '' . "\0" . 'Sulu\\Bundle\\RouteBundle\\Entity\\Route' . "\0" . 'target', 'histories', 'creator', 'changer', 'created', 'changed'];
        }
    ...
    public function getResourcelocator()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getResourcelocator', []);
