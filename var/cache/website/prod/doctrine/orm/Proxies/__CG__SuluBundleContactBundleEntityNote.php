 ...
 */
class Note extends \Sulu\Bundle\ContactBundle\Entity\Note implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Note' . "\0" . 'value', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Note' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Note' . "\0" . 'contacts', '' . "\0" . 'Sulu\\Bundle\\ContactBundle\\Entity\\Note' . "\0" . 'accounts'];
        }
