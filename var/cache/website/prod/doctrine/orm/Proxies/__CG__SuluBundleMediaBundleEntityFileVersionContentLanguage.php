 ...
 */
class FileVersionContentLanguage extends \Sulu\Bundle\MediaBundle\Entity\FileVersionContentLanguage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\FileVersionContentLanguage' . "\0" . 'locale', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\FileVersionContentLanguage' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\MediaBundle\\Entity\\FileVersionContentLanguage' . "\0" . 'fileVersion'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FileVersionContentLanguage $proxy) {
