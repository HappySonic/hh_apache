 ...
 */
class UserRole extends \Sulu\Bundle\SecurityBundle\Entity\UserRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'locale', 'user', 'role', 'apiBasePath', 'apiPath'];
        }
     ...
     * {@inheritDoc}
     */
    public function setRole(\Sulu\Component\Security\Authentication\RoleInterface $role)
    {
